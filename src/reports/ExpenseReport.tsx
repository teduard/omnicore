...
import type { IExpenseRow, IExpenseCategoryAggregateRow } from '../modules/ExpenseApp/interfaces/data';
...
const styles = StyleSheet.create({
  ...
  expenseComCol:  { flex: 2, color: '#5f6b7a' },
  expenseAmtCol:  { width: 70, textAlign: 'right', fontFamily: 'Helvetica-Bold' },
  expenseAvdCol:  { width: 30, textAlign: 'center', color: '#d91515' },
...
export function ExpenseReport({
  ...
  const sortedCategories = [...categoryAggregate]
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.summaryRow}>
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>{total} {currency}</Text>
          </View>
          <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryCard}>
            ...
            <Text style={styles.summaryValue}>{avoidableTotal} {currency}</Text>
          </View>
          <View style={styles.summaryCard}>
        ...
        <View style={styles.tableHeader}>
          <Text style={[styles.tableHeaderText, styles.expenseDateCol]}>Date</Text>
          <Text style={[styles.tableHeaderText, styles.expenseCatCol]}>Category</Text>
          <Text style={[styles.tableHeaderText, styles.expenseComCol]}>Comment</Text>
          <Text style={[styles.tableHeaderText, styles.expenseAmtCol]}>Amount</Text>
          <Text style={[styles.tableHeaderText, styles.expenseAvdCol]}>!</Text>
        </View>

        {expenses.map((expense, i) => (
          <View
            key={expense.expenseId}
            style={[styles.expenseRow, i % 2 !== 0 && { backgroundColor: '#f8f9fa' }]}
          >
